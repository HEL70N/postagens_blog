...
class CategoriesController
{
    ...
    public function new()
    {
        try {
            ...
            Flash::add('error', 'Ocorreu um problema interno, por favor contacte  Admin');
            return header('Location: ' . HOME . '/categories');
        }
    }
    ...
    public function edit($id = null)
    {
        try {
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if (!$post->update($data)) {
                    Flash::add('error', 'Erro ao actualizar categoria!');
                    return header('Location: ' . HOME . '/categories/edit/' . $id);
                }

                Flash::add('success', 'Categoria actualizada com sucesso!');
                return header('Location: ' . HOME . '/categories/edit/' . $id);
            }
